...
class ActivityControllerTest {
    ...
    // helper function to add a test user associated with an activity to the database
    ...
    inner class CreateActivities {
        ...
        fun `add an activity when no user exists for it, returns a 404 response`() {
            ...
            val addActivityResponse = addActivity(
                ...
                activities.get(0).duration,
                activities.get(0).calories,
                activities.get(0).started,
                userId,
            )
